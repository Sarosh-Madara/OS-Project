...
public class SRTF {
    public static void main(String args[])
 {
     ...
     for(int i = 1; i <= noOfJobs; i++)
     {
      System.out.printf("%d\t%2dsec\t%2dsec",i,proc[i][2],proc[i][3]);
      System.out.println();
     }
     ...
     WT /= noOfJobs;
     TT /= noOfJobs;
     System.out.println("The Average WT is: " + WT + "sec");
     System.out.println("The Average TT is: " + TT + "sec");
     inp.close();
 }
}
